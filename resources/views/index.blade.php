...
<body>
    ...
    <section id="intro">
        <img src={{ asset("Imagenes/Logo_BuscaTuEmpleo.png") }} alt="BuscaTuEmpleoIdeal.com">          
        <h2>¡No esperes más!</h2>
        <p>Con buscatuempleoideal.com encuentra tu empleo anhelado y el que cumpla con tus preferencias.
        Registrate, busca y aplíca de manera rapida y sencilla al trabajo que tu quieras.
        </p>
    </section>
    
    <section>        
        <h2>OFERTAS DE TRABAJO PUBLICADAS RECIENTEMENTE</h2>
        <ul class="job-list">
            <li job-id="1">
                <img src={{ asset("Imagenes/images.png") }} alt="Logo de la empresa">
                <h3>Ingeniero Quimico</h3>
                <p class="nombre-empresa">Coca-Cola</p>
                <p class="direccion"><i class="fas fa-location-arrow"></i>Managua, Nicaragua</p>
                <button class="fav"><i class="far fa-bookmark"></i></button>
                <a>Ver más</a>
            </li>
            <li job-id="2">
                <img src={{ asset("Imagenes/Logo_UNI_(1).png") }} alt="Logo de la empresa">
                <h3>Docente</h3>
                <p class="nombre-empresa">Universidad Nacional de Ingenieria</p>
                <p class="direccion"><i class="fas fa-location-arrow"></i>Managua, Nicaragua</p>
                <button class="fav"><i class="far fa-bookmark"></i></button>
                <a>Ver más</a>
            </li>   
            <li job-id="3">
                ...
                <p class="nombre-empresa">Nombre de la empresa</p>
    ...
    <section>        
        <h2>OFERTAS DE TRABAJO AÚN DISPONIBLES</h2>
        <ul class="job-list">
            <li job-id="11">
                <img src="" alt="Logo de la empresa">
                <h3>Nombre del trabajo</h3>
    ...
    <section id="enterprises">
        <img src={{ asset("Imagenes/Logos_empleo.png" ) }} alt="Logos">    
    </section>

    <section id="description">
        <h2>¿Porqué elegirnos?</h2>
        <p>buscatuempleoideal.com es un sitio web de empleos cuyo objetivo
            es hacer de que nuestros usuarios encuentren su trabajo ideal con
            miles de ofertas que se actualizán de forma constante, todos 
            estos empleos son publicados en diferentes países, regístrate, crea
            tu perfil y postulate a tu trabajo ideal. 
        </p>
        <p>Tu proximo empleo espera por ti.</p>
    </section>
